...
# Generated by qmake (3.0) (Qt 5.0.1) on: pt. mar 8 14:46:12 2013
# Project:  oscillator-errors.pro
# Template: app
# Command: /usr/bin/qmake -spec linux-clang -o Makefile oscillator-errors.pro
#############################################################################
...
CFLAGS        = -pipe -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector --param=ssp-buffer-size=4 -D_FORTIFY_SOURCE=2 -Wall -W -D_REENTRANT -fPIE $(DEFINES)
CXXFLAGS      = -pipe -march=x86-64 -mtune=generic -O2 -pipe -fstack-protector --param=ssp-buffer-size=4 -D_FORTIFY_SOURCE=2 -Wall -W -D_REENTRANT -fPIE $(DEFINES)
...
Makefile: oscillator-errors.pro /usr/lib/qt/mkspecs/linux-clang/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		/lib/libQt5Gui.prl \
		/lib/libQt5Core.prl
	$(QMAKE) -spec linux-clang -o Makefile oscillator-errors.pro
