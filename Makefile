...
# Generated by qmake (3.0) (Qt 5.0.1) on: Sat Mar 9 20:58:02 2013
...
SOURCES       = main.cpp \
		...
		qcustomplot.cpp \
		timeplot.cpp \
		phaseplot.cpp moc_mainwindow.cpp \
		moc_paintwidget.cpp \
		moc_qcustomplot.cpp
OBJECTS       = main.o \
		mainwindow.o \
